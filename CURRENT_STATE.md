...
and `GE`/`GigabitEthernet`, plus `Loop`/`LoopBack`), while preserving the
description-side name and subinterface suffix in normalized output. Known VRP brief legends and protocol
